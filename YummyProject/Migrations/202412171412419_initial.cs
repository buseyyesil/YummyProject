    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        TestMonialId = c.Int(nullable: false, identity: true),
                        ImageUrl = c.String(),
                ...
                .PrimaryKey(t => t.TestMonialId);
            
        }
        
        public override void Down()
        {
            DropForeignKey("dbo.ChefSocials", "Chef_ChefId", "dbo.Chefs");
            DropForeignKey("dbo.Products", "CategoryId", "dbo.Categories");
            DropIndex("dbo.ChefSocials", new[] { "Chef_ChefId" });
            DropIndex("dbo.Products", new[] { "CategoryId" });
            DropTable("dbo.TestMonials");
